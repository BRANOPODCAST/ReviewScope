    ...
    Tables: {
      analysis_results: {
        Row: {
          ...
          coordination_analysis: Json | null
          created_at: string
          id: string
          integrity_assessment: Json | null
          key_signals: Json | null
          manipulation_band: string | null
          pattern_discovery: Json | null
          preprocessing: Json | null
          review_clusters: Json | null
        ...
        Relationships: [
          {
            foreignKeyName: "analysis_results_batch_id_fkey"
            columns: ["batch_id"]
            isOneToOne: true
